          ...
          (1..16).each do |carnum|
            ...
            seat_list.each do |seat|
              ...
              seat_reservation_list.each do |seat_reservation|
                ...
                halt_with_error 404, 'reservation is not found' if reservation.nil?
                ...
                halt_with_error 404, 'departure_station is not found' if departure_station.nil?
                ...
                halt_with_error 404, 'arrival_station is not found' if arrival_station.nil?
