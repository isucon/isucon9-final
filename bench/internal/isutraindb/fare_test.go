...
func TestFareMultiplier(t *testing.T) {
	tests := []struct {
		...
		},
		{
			trainClass:         "最速",
			seatClass:          "premium",
			startDate:          time.Date(2020, 01, 06, 0, 0, 0, 0, time.UTC),
		...
		},
		{
			trainClass:         "最速",
			seatClass:          "premium",
			startDate:          time.Date(2020, 03, 13, 0, 0, 0, 0, time.UTC),
		...
		},
		{
			trainClass:         "最速",
			seatClass:          "premium",
			startDate:          time.Date(2020, 04, 24, 0, 0, 0, 0, time.UTC),
			wantFareMultiplier: 15.000,
		},
		{
			trainClass:         "最速",
		...
		},
		{
			trainClass:         "最速",
			seatClass:          "premium",
			startDate:          time.Date(2020, 05, 11, 0, 0, 0, 0, time.UTC),
			wantFareMultiplier: 3.000,
		},
		{
			trainClass:         "最速",
		...
		},
		{
			trainClass:         "最速",
			seatClass:          "premium",
			startDate:          time.Date(2020, 8, 07, 0, 0, 0, 0, time.UTC),
			wantFareMultiplier: 9.000,
		},
		{
			trainClass:         "最速",
		...
		},
		{
			trainClass:         "最速",
			seatClass:          "premium",
			startDate:          time.Date(2020, 8, 24, 0, 0, 0, 0, time.UTC),
			wantFareMultiplier: 3.000,
		},
		{
			trainClass:         "最速",
		...
		// 間の値
		{
			trainClass:         "遅いやつ",
			seatClass:          "non-reserved",
			startDate:          time.Date(2020, 1, 05, 0, 0, 0, 0, time.UTC),
			wantFareMultiplier: 4.000,
		},
	}
